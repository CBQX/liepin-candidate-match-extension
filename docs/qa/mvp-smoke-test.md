...
- [ ] 7. 确认结果只包含轻量报告：0–100 综合匹配分、三档联系建议、2–5 条主要匹配理由、最多 3 条主要顾虑或信息缺口、最多 3 个建议核实问题和一段猎头结论。每条理由和顾虑都必须同时显示岗位依据与候选人依据；联系建议只能是“建议联系 / 联系前先核实 / 暂不优先联系”，没有淘汰选项。确认页面不再出现六维评分或硬性条件核对，并用材料缺失样本确认缺失内容进入顾虑或核实问题，而不是仅因缺失直接扣分。
