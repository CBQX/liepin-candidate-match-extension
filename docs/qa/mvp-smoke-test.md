...
- [ ] 7. 确认结果包含总分、推荐等级、可信度、六维评分、硬性条件及证据、匹配项、不匹配项、风险、缺失信息、核实问题、沟通建议和猎头结论。用合成文本分别覆盖地点、工作年限和证书的明确正向、否定、范围、计划或失效表述，确认这三类确定性硬规则始终为“未知”，不会自动满足、淘汰或降级；同时确认原文仍出现在模型证据/核实建议中，并用明确学历样本确认当前安全结构化规则仍可显示“满足/不满足”。
